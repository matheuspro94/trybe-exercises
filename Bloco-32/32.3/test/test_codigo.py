...
# def test_get_order_frequency_per_costumer_when_customer_is_joao_and_order_is_
# pizza(orders):
#     assert get_order_frequency_per_costumer(orders, "joao", "pizza") == 0

# def test_get_order_frequency_per_costumer_when_customer_is_maria_and_order_
# is_hamburger(orders):
